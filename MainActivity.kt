...
import com.example.classseek.Notification.CounterNotificationService
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                "Counter",  // Remove the "name = " prefix - just put the string directly
                NotificationManager.IMPORTANCE_DEFAULT
            )
            channel.description = "Used for the increment of the counter notification"
